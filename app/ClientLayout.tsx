...
import { Home, BarChart2, TrendingUp, DollarSign, User } from "lucide-react"
...
export default function ClientLayout({
  ...
  useEffect(() => {
    // Check if we're on localhost:3000 or the home page
    const isLocalhost = window.location.host === "localhost:3000"
    const isHomePage = pathname === "/"
    setShowSidebar(!isLocalhost && !isHomePage)
  }, [pathname])
