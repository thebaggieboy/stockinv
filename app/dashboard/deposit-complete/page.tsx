...
export default function DepositSuccessPage() {
  ...
  return (
    <div className="container justify-center max-w-2xl py-8">
      <Link href="dashboard/wallet" className="flex items-center text-sm text-blue-500 hover:text-blue-600 mb-6">
      ...
      <div className="flex flex-col items-center justify-center mb-8">
        ...
        <p className="text-muted-foreground text-center">
          Your deposit has been successfully processed and your funds would be added to your wallet soon.
        </p>
      </div>
